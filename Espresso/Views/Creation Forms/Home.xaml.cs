...
namespace Espresso.Views
{
    ...
    public partial class Home : Window
    {
        ...
        private void NewOtherProfit(object sender, RoutedEventArgs e)
        {
            new NewOtherProfit().ShowDialog();
        }

        private void OtherProfits(object sender, RoutedEventArgs e)
        {
            new OtherProfits().ShowDialog();
        }
    }
}
